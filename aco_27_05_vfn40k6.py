...
Original file is located at
    https://colab.research.google.com/drive/18gS0iMz3yI_TOYyC9MsVQl5t35JjXtWf
"""
...
demandes_df = pd.read_excel("/content/demandes clients merg.xlsx", index_col="date")

# Lire les coordonnées (en supposant que la colonne "client" contient "entrepot", "CL1", etc.)
coordonnees_df= pd.read_excel("/content/les coordonnées des 40 clients et l'entrepot.xlsx", sheet_name="Feuil1",index_col="client ")
...
time_windows_df = pd.read_excel("fenetres_temps.xlsx", index_col="Client")
...
service_times_df = pd.read_excel("temps_service.xlsx", index_col="Client")
...
def objective(trial):
    ...
    params = {
        "n_vehicules": trial.suggest_int("n_vehicules", 1, 6),
    ...
    vehicules_data = {
            ...
            2: {"type": "electrique", "emissions": 120, "age": 1},
...
def visualiser_route(solution, coordonnees_df):
    ...
    clients = [f"CL{i}" for i in range(1, 41)]
...
demandes_df = pd.read_excel("/content/demandes clients merg.xlsx", index_col="date")
coordonnees_df = pd.read_excel("/content/les coordonnées des 40 clients et l'entrepot.xlsx", index_col="client ")

# Préparation des données
clients_ordered = [f"CL{i}" for i in range(1, 41)]
coords = coordonnees_df.loc[["entrepot"] + clients_ordered][["X", "Y"]].values
dist_matrix = distance_matrix(coords, coords)
date_cible = demandes_df.index[0]
demandes = [0] + [demandes_df.loc[date_cible, f"CL{i}"] for i in range(1, 41)]
...
vehicules_data = {
            0: {"type": "essence", "emissions": 150, "age": 5},
            1: {"type": "diesel", "emissions": 180, "age": 7},
            2: {"type": "electrique", "emissions": 120, "age": 4},
            3: {"type": "hybride", "emissions": 130, "age": 6},
            4: {"type": "diesel", "emissions": 170, "age": 5},
            5: {"type": "essence", "emissions": 160, "age": 4}
        }
